      ...
      for (int width : {16, 36}) {
        ...
        for (bool dither : {false, true}) {
          if (dither && vi.BitsPerComponent() > 10 && vi.BitsPerComponent() != 32)
            continue;
          compare(env, "Levels", {source, 0.05f * max, 1.2f, .9f * max, .1f * max, .95f * max, false, dither});
          compare(env, "Levels", {source, 0.0f, 1.0f, max, 0.0f, max, true, dither});
          if (vi.IsRGB()) {
            compare(env, "RGBAdjust",
        ...
        if (!vi.IsRGB()) {
          compare(env, "ColorYUV", {source, 12.f, -3.f, 7.f, 5.f, -8.f, 2.f, 4.f, 0.f, 3.f, -2.f, 0.f, 4.f});
          compare(env, "ColorYUV", {source, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, "TV->PC"});
        }
      }
