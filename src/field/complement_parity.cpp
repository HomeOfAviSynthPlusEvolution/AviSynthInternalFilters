...
ComplementParity::ComplementParity(PClip _child) : NonCachedGenericVideoFilter(_child) {
...
bool __stdcall ComplementParity::GetParity(int n) {
  return !child->GetParity(n);
}
AVSValue __cdecl ComplementParity::Create(AVSValue args, void*, IScriptEnvironment* env) {
  (void)env;
