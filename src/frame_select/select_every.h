...
public:
  ...
  static AVSValue __cdecl Create_SelectEven(AVSValue args, void*, IScriptEnvironment* env);

  static AVSValue __cdecl Create_SelectOdd(AVSValue args, void*, IScriptEnvironment* env);
