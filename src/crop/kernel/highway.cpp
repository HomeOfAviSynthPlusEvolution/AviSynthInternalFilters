...
extern "C" uint32_t aif_crop_supported_cpu(void) {
#ifndef AIF_SCALAR_ONLY
  ...
  if (t & HWY_AVX3_DL)
    cpu |= AIF_CROP_AVX3_DL;
#endif
#if HWY_TARGETS & HWY_AVX3_ZEN4
  if (t & HWY_AVX3_ZEN4)
    cpu |= AIF_CROP_AVX3_ZEN4;
#endif
#if HWY_TARGETS & HWY_AVX3_SPR
  if (t & HWY_AVX3_SPR)
    cpu |= AIF_CROP_AVX3_SPR;
#endif
#if HWY_TARGETS & HWY_AVX10_2
  if (t & HWY_AVX10_2)
    cpu |= AIF_CROP_AVX10_2;
#endif
